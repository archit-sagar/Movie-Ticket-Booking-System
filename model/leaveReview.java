...
public class leaveReview implements ActionListener {
    ...
    leaveReview(String username, String moviename) {
        ...
        frame.setContentPane(new JLabel(new ImageIcon(
                new ImageIcon(".\\Images\\moviereel.jpg").getImage().getScaledInstance(1000, 650, Image.SCALE_DEFAULT))));
        ...
        reviewRating = new JComboBox(ratings);
        reviewRating.setBounds(650, 210, 100, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submitButton) {
            String rating = (String) reviewRating.getSelectedItem();
